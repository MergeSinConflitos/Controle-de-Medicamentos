...
O hospital Teresa Ramos contratou a acadêmia do programador para desenvolver um sistema que automatize o gerenciamento de alguns setores:
...
A gerencia deseja que tais campos sejam mais faceis de administar após nossa ajuda,para poder oferecer o melhor serviço possivel tanto a equipe do hospital,quanto aos pacientes que buscam seu auxilio todos os dias.
...
- O sistema deve subtrair a quantidade do estoque
